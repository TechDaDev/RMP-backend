...
urlpatterns = [
    ...
    path(
        "doctor/pending/",
        DoctorPendingConsultationListView.as_view(),
        name="doctor-pending-consultations",
    ),
    path(
        "doctor/assigned/",
        DoctorAssignedConsultationListView.as_view(),
        name="doctor-assigned-consultations",
    ),
    ...
    path(
        ...
        name="consultation-accept",
    ),
    path(
        "<uuid:consultation_id>/responses/",
        ConsultationResponseCreateView.as_view(),
        name="consultation-response-create",
    ),
    path(
        "<uuid:consultation_id>/close/", ConsultationCloseView.as_view(), name="consultation-close"
    ),
    path(
        "<uuid:consultation_id>/prescriptions/",
        PrescriptionCreateView.as_view(),
        name="prescription-create",
    ),
    path(
        "<uuid:consultation_id>/lab-orders/", LabOrderCreateView.as_view(), name="lab-order-create"
    ),
