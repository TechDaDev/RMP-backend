...
class LabOrderAdmin(admin.ModelAdmin):
	list_display = ("id", "doctor", "patient", "status", "expires_at", "fully_completed_at", "created_at")
...
class LabResultCorrectionInline(admin.TabularInline):
	...
	extra = 0
	readonly_fields = ("id", "corrected_by", "previous_data", "new_data", "reason", "created_at", "updated_at")
	can_delete = False
...
class LabResultAdmin(admin.ModelAdmin):
	...
	list_filter = ("status", "value_type", "flag", "is_linked_to_medical_record", "created_at", "released_at")
	search_fields = (
		"patient__email",
		"doctor__email",
		"laboratorian__email",
	...
	readonly_fields = ("id", "submitted_at", "reviewed_at", "released_at", "corrected_at", "created_at", "updated_at")
...
class LabResultCorrectionAdmin(admin.ModelAdmin):
	...
	search_fields = ("lab_result__patient__email", "lab_result__doctor__email", "corrected_by__email")
	readonly_fields = ("id", "created_at", "updated_at")
