...
urlpatterns = [
    ...
    path(
        "my/<uuid:lab_order_id>/",
        PatientLabOrderDetailView.as_view(),
        name="patient-lab-order-detail",
    ),
    path(
        "doctor/<uuid:lab_order_id>/",
        DoctorLabOrderDetailView.as_view(),
        name="doctor-lab-order-detail",
    ),
    path(
        "doctor/<uuid:lab_order_id>/cancel/",
        DoctorCancelLabOrderView.as_view(),
        name="doctor-lab-order-cancel",
    ),
    path("scan/", LaboratorianLabOrderScanView.as_view(), name="laboratorian-lab-order-scan"),
    path(
        "<uuid:lab_order_id>/complete/",
        LaboratorianCompleteLabOrderItemsView.as_view(),
        name="laboratorian-complete-lab-order-items",
    ),
    path(
        "items/<uuid:lab_order_item_id>/results/",
    ...
    path(
        "results/<uuid:lab_result_id>/correct/",
        LabResultCorrectionView.as_view(),
        name="lab-result-correct",
    ),
    path(
        "doctor/results/<uuid:lab_result_id>/",
        DoctorLabResultDetailView.as_view(),
        name="doctor-lab-result-detail",
    ),
    path(
        "doctor/results/<uuid:lab_result_id>/review/",
        DoctorReviewLabResultView.as_view(),
        name="doctor-lab-result-review",
    ),
    path(
        "doctor/results/<uuid:lab_result_id>/release/",
        DoctorReleaseLabResultView.as_view(),
        name="doctor-lab-result-release",
    ),
    path(
    ...
    path(
        "my-results/<uuid:lab_result_id>/",
        PatientLabResultDetailView.as_view(),
        name="patient-lab-result-detail",
    ),
]
